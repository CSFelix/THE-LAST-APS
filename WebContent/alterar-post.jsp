...
<html lang="pt-br, en">
	...
	<body>
		...
		<section id="mainContent">
			...
			<!-- painel -->
			<jsp:include page="includes/sections/section-alterar-post.jsp" />
		</section>
	</body>
	...
	<script type="text/javascript" src="assets/js/vue/languages/sections/section-alterar-post.js"></script>
	...
	<!-- ajax -->
	<script type="text/javascript" src="assets/js/ajax/ajax-alterar-post.js"></script>
</html>