...
if (idiomaAtual) {
    ...
    /* usado somente na página de cadastro de post */
    try { vueAtivarControladorIdiomaPainelCadastroPost(); }
    catch (exception) { }
    
    /* usado somente na página de alteração de post */
    try { vueAtivarControladorIdiomaPainelAlterarPost(); }
    catch (exception) { }
    
    /* usado somente na página de visualização de post */
    try { vueAtivarControladorIdiomaPainelVisualizarPost(); }
    catch (exception) { }
}
